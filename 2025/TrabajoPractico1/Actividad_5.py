# 5) Para una serie de números enteros (pueden ingresar números de 1 dígito
...
cantidadCapicuas = 0; cantidadValorDeterminado = 0; digitoIzquierda = 0
valorDeterminado = int(input("Ingrese un número determinado para comparar con el valor de la decena: "))
...
while numero < 0 or numero > 99999:
    print("El número debe estar comprendido entre 0 y 99.999")
...
while numero != 0:
    ...
    if numero != 0:
        ...
        # Punto a
        if numero >= 10000 and numero <= 99999: # Caso para número de 5 dígitos
            ...
            if numero >= 1000 and numero <= 9999: # Caso para número de 4 dígitos
                if unidad_mil == unidad and centena == decena:
                    print("El número es capicua ", numero)
                    cantidadCapicuas = cantidadCapicuas + 1
                digitoIzquierda = unidad_mil # Punto c
            else:
                if numero >= 100 and numero <= 999: # Caso para número de 3 dígitos
                    if centena == unidad:
                        print("El número es capicua ", numero)
                        cantidadCapicuas = cantidadCapicuas + 1
                    digitoIzquierda = centena # Punto c
                else:
                    if numero >= 10 and numero <= 99: # Caso para número de 2 dígitos
                        if decena == unidad:
                            print("El número es capicua ", numero)
                            cantidadCapicuas = cantidadCapicuas + 1
        ...
        # Punto b
        if numero >= 10: # Esta condición es para garantizar que el número tiene decena
        ...
        if auxEsParImpar != 0 and digitoIzquierda > 4:
            print("El número tiene en su primer dígito de la izquierda un valor impar mayor a 4")
    # Se realiza ciclo para garantizar que el numero tenga entre 1 a 5 digitos
    numero = int(input("Ingrese un número (0 al 99.999): "))
    while numero < 0 or numero > 99999:
        print("El número debe estar comprendido entre 0 y 99.999")
...
print("-----------------------------------------------------------------------------")
print("La cantidad de números cuyo dígito de la decena es menor a ",cantidadValorDeterminado," es de:",cantidadValorDeterminado)
print("-----------------------------------------------------------------------------")