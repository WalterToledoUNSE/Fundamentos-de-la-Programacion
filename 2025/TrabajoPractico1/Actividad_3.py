# 3) Un comerciante desea saber de sus N empleados:
# a) El mayor sueldo de 5 dígitos.
# b) El promedio de los sueldos entre $ 80.000 y $ 110.000.
...
while c < N:
    ...
    # print("El sueldo incrementado es: ",sueldoActualizado) #Impreme el sueldo con el formato estandar (puede tener más de 2 decimales)
...
if c1 > 0: # Esta condición evita la división por cero
    prom = sum / c1
print("----------------------------------------------------------------------")
print("El promedio de los sueldos entre $ 80.000 y $ 110.000 es: $ %.2f"%prom)
print("----------------------------------------------------------------------")