# 2) Dada una serie de números, cuyo final viene dado por el ingreso
...
# c) El promedio de edad de este grupo de alumnos.
...
while edad > 0:
    ...
    edad = int(input("Ingrese la edad del alumno: "))
if c > 0: # Condición para evitar la división por cero
...
if c > 0: # Condición para evitar la división por cero
    media = sum / c
print("---------------------------------------------------------")
print("El promedio de edad de este grupo de alumnos: ",media)
print("---------------------------------------------------------")