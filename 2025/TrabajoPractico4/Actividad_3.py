...
for i in range(K):
    jugadores[i]["codigoJugador"] = int(input("Ingrese el código del jugador: "))
    jugadores[i]["equipo"]["nombreEquipo"] = input("Ingrese el nombre del equipo: ")
    jugadores[i]["equipo"]["pais"] = input("Ingrese el país: ")
    jugadores[i]["puntajeTotal"] = int(input("Ingrese el puntaje total: "))
    print(" ")
...
# Item A
print(" ")
print("Listado de jugadores con mas de 1.000 puntos")
